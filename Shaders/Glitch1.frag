...
void main() {
 vec4 fg = texture2D(uSampler, vTextureCoord);
    ...
    vel *= (step(1., mod(ipos.y,2.552))-1.164)*2.080*gl_FragCoord.xy/u_resolution.xy; // Oposite directions
    ...
    color = smoothstep(0.464,0.036+u_resolution.y/u_resolution.x*.5,color*color); // smooth
    color = step(0.044+u_time/u_resolution.x*-0.324,color); // threshold
